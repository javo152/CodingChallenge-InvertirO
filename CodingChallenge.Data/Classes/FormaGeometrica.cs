...
namespace CodingChallenge.Data.Classes
{
    public class FormaGeometrica
    {
        ...
        private static string TraducirForma(int tipo, int cantidad, int idioma)  //implementa cada clase
        {
            switch (tipo)
            {
                case Cuadrado:
        ...
        public decimal CalcularArea()  //implementa cada clase
        {
            switch (Tipo)
            {
        ...
        public decimal CalcularPerimetro()  //implementa cada clase
        {
            switch (Tipo)
            {
